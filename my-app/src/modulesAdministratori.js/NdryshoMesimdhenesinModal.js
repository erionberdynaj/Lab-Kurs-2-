...
const NdryshoMesimdhenesinModal = ({ showModal, closeModal,mesimdhenesiID,stafiID,emri_mbiemri,email,fotoPath,nrTelefonit,vendbanimi,kualifikimi }) => {
    ...
    const handleNdryshoClick = async () => {
        try {
          ...
          const mesimdhenesiData= {
            ...
            const response = await axios.put(`https://localhost:44335/mesimdhenesi`, mesimdhenesiData);
            console.log(response.data);
          
            toast.success('Mesimdhenesi u ndryshua me sukses', { autoClose: 1500 });
            setTimeout(() => {
              closeModal();
...
export default NdryshoMesimdhenesinModal;
